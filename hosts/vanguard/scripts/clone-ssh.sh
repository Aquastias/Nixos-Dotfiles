...
readonly AGE_ENCRYPTED_FILENAME="Git-SSH.tar.gz.enc.age"
readonly OPENSSL_ENCRYPTED_FILENAME="Git-SSH.tar.gz.enc"
...
readonly AGE_INPUT_FILE="${TEMP_VAULT_DIR}/${AGE_ENCRYPTED_FILENAME}"
readonly OPENSSL_INPUT_FILE="${TEMP_VAULT_DIR}/${OPENSSL_ENCRYPTED_FILENAME}" 
